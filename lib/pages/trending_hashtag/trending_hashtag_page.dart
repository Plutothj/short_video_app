...
class TrendingHashtagPage extends HookConsumerWidget {
  const TrendingHashtagPage({super.key});

  Widget _buildHashtagTopInfo() {
    return Container(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/images/jinghao.webp'),
                fit: BoxFit.contain,
              ),
            ),
            child: Text(''),
              ...
              children: [
                ...
                OutlinedButton.icon(
                  ...
                  style: ButtonStyle(
                    ...
                    minimumSize: WidgetStateProperty.all(Size(185.w, 38.h)),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            _buildHashtagTopInfo(),
            // _buildSoundsButtons(),
            _buildHashtagGridView(),
          ],
        ),
      ),
    );
